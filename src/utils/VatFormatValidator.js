...
function BEVATCheckDigit(vatnumber) {
  ...
  if (97 - (vatnumber.slice(0, 8) % 97) == vatnumber.slice(8)) return true;
  else return false;
}
...
function BRVATCheckDigit(vatnumber) {
  ...
  if (temp != Number(vatnumber.charAt(13))) return false;
  else return true;
}
...
function CZVATCheckDigit(vatnumber) {
  ...
  if (czexp[0].test(vatnumber)) {
    ...
    // Compare it with the last character of the VAT number. If it's the same, then it's valid.
    if (total == vatnumber.slice(7)) return true;
    else return false;
  }
  ...
  // Individuals type 2 (Special Cases) - 9 digits including check digit
    ...
    if (total % 11 == 0) a = total + 11;
    else a = Math.ceil(total / 11) * 11;
    var pointer = a - total;
...
function DEVATCheckDigit(vatnumber) {
  ...
  // Establish check digit.
  if (11 - product == 10) checkdigit = 0;
  else checkdigit = 11 - product;

  // Compare it with the last two characters of the VAT number. If the same, then it is a valid
  // check digit.
  if (checkdigit == vatnumber.slice(8)) return true;
  else return false;
}
...
function GBVATCheckDigit(vatnumber) {
  ...
  if (cd == vatnumber.slice(7) && no > 1000000) return true;
  else return false;
}
...
function HRVATCheckDigit(vatnumber) {
  ...
  if ((product + vatnumber.slice(10) * 1) % 10 == 1) return true;
  else return false;
}
...
function ITVATCheckDigit(vatnumber) {
  ...
  // Compare it with the last character of the VAT number. If it's the same, then it's valid.
  if (total == vatnumber.slice(10)) return true;
  else return false;
}
...
function LTVATCheckDigit(vatnumber) {
  ...
  // 12 character VAT numbers are for temporarily registered taxpayers
    ...
    // Compare it with the last character of the VAT number. If it's the same, then it's valid.
    if (total == vatnumber.slice(11)) return true;
    else return false;
  }
}
...
function LUVATCheckDigit(vatnumber) {
  ...
  if (vatnumber.slice(0, 6) % 89 == vatnumber.slice(6)) return true;
  else return false;
}
...
function MTVATCheckDigit(vatnumber) {
  ...
  if (total == vatnumber.slice(6)) return true;
  else return false;
}
...
function NLVATCheckDigit(vatnumber) {
  ...
  function convert_string_tonumeric(vatstring) {
    ...
    for (var i = 0; i < vat.length; i++) {
      ...
      if (nextchar == 42) nextchar = 37;
      // If it is a '+' convert to numeric 37
      else if (nextchar == 43) nextchar = 36;
...
function PLVATCheckDigit(vatnumber) {
  ...
  // Compare it with the last character of the VAT number. If it's the same, then it's valid.
  if (total == vatnumber.slice(9)) return true;
  else return false;
}
...
function RSVATCheckDigit(vatnumber) {
  ...
  // Now check that we have the right check digit
  if ((product + vatnumber.slice(8) * 1) % 10 == 1) return true;
  else return false;
}
...
function SIVATCheckDigit(vatnumber) {
  ...
  if (total != 11 && total == vatnumber.slice(7)) return true;
  else return false;
}
